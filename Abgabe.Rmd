...
The R package party provides the lowest values for all used GoF. The ranger package provides the best fit for all GoF in most of the hyperparameter combinations.
...
One major argument why the predicted results differ is described in the documentation of the party package [@Thothorn (2023), S.6]:
