...
Compare this image with the image above for the F-Beta Score for empirical data. For the purpose of clarification - the missing values resulting from NAs in the computation in the F-Beta score are based on small values in either Precision or Recall.
